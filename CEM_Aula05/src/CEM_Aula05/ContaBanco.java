...
public class ContaBanco {
    ...
    public void fecharConta() {
        if (this.getSaldo() > 0) {
            System.out.println("Conta de " + this.getDono() + " possui credito!");
        } else if (this.getSaldo() < 0) {
            System.out.println("Conta " + this.getDono() + " possui debitos");
        } else {
    ...
    public void depositar(float v) {
        if (this.getStatus()) {
            ...
            System.out.println("Impossivel depositar em uma conta encerrada");
        }
    }
    ...
    public void sacar(float v) {
        if (this.getStatus()) {
            ...
            System.out.println("Impossivel sacar de conta encerrada!");
        }
    }
